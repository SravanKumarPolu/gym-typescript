...
const ContactUs = ({ setSelectedPage }: Props) => {
    const inputStyles = `mt-4 w-full rounded-lg bg-primary-500 px-4 py-3 placeholder-white`
              ...
              >
                  ...
                  >
                      <form
                          ...
                          onSubmit={onSubmit}
                          method="POST"
                          action="https://formsubmit.com/sravanpolu.me@gmail.com"
...
<input className={inputStyles}
                          ...
                          <button
                              ...
                              trasition duaration-500 hover:text-white"
                          >
                            SUBMIT  
                          </button>
                      </form>
